        ...
        if 'binary' in gcm_dict:
            ...
            def fun():
                return twoface_to_pygcm(
                    ...
                    p2d=u.Quantity(args_dict['p2d']),
                    t0d=u.Quantity(args_dict['t0d']),
                    t1d=u.Quantity(args_dict['t1d']),
                    t2d=u.Quantity(args_dict['t2d']),
                    p0n=u.Quantity(args_dict['p0n']),
                    p1n=u.Quantity(args_dict['p1n']),
                    p2n=u.Quantity(args_dict['p2n']),
                    t0n=u.Quantity(args_dict['t0n']),
                    t1n=u.Quantity(args_dict['t1n']),
                    t2n=u.Quantity(args_dict['t2n']),
                    n_troposphere=int(args_dict['n_troposphere']),
                    n_stratosphere=int(args_dict['n_stratosphere']),
                    n_isothermal=int(args_dict['n_isothermal']),
                    ...
                    h2o_d2=u.Quantity(args_dict.get('h2o_d2', LOW_ABN)),
                    h2o_n0=u.Quantity(args_dict.get('h2o_n0', LOW_ABN)),
                    h2o_n1=u.Quantity(args_dict.get('h2o_n1', LOW_ABN)),
                    h2o_n2=u.Quantity(args_dict.get('h2o_n2', LOW_ABN)),
